...
void configure_gpio_interrupt(void)
{
    ...
    io_conf.pin_bit_mask = (1ULL << INTERRUPT_PIN_A) | (1ULL << INTERRUPT_PIN_B);  // Bit mask of the pin
    ...
    gpio_isr_handler_add(INTERRUPT_PIN_A, gpio_isr_handler, (void*) INTERRUPT_PIN_A);
    gpio_isr_handler_add(INTERRUPT_PIN_B, gpio_isr_handler, (void*) INTERRUPT_PIN_B);
